#!/usr/bin/env bash
#
# Control run: Single Claude Code agent, no DKG, sequential features.
#
set -euo pipefail
...
echo "=== Control Run: Single Agent, No DKG ==="
...
echo "=== Round 2 (warm — same agent continues) ==="
