...
export class DKGAgent extends DKGAgentBase {
   ...
   */
  async registerCgForBeaconAnnouncement(
    localCgId: string,
    accessPolicy: number,
   ...
   */
  bindSubscriptionOnChainId(localCgId: string, sub: ContextGraphSub, newOnChainId: string): void {
...
export interface DKGAgent extends ContextGraphMethods {}
