...
export class DKGAgent extends DKGAgentBase {
  ...
  upsertContextGraphMember(record: ContextGraphMembershipRecord): void {
...
export interface DKGAgent extends ContextGraphMethods, SwmHostModeMethods, PublishMethods {}
applyMixins(DKGAgent, [ContextGraphMethods, SwmHostModeMethods, PublishMethods]);
