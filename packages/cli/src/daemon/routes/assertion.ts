...
//
// The helper functions / types / classes below were extracted verbatim into
// `./shared-assertion-helpers.ts` so the new `/api/knowledge-assets` route
// ports can reuse them while this module is wound down. They are imported
// back here so the route handlers in this file keep working unchanged.
import {
...
// Re-exported for back-compat: the async-promote wire-schema types were
// originally exported from this module (RFC §3.2/§3.3).
export { type PromoteJobView, type PromoteJobErrorView } from './shared-assertion-helpers.js';
