...
export default defineConfig({
  test: {
    include: runsDaemonHttpBehavior
      ...
      : ['test/api-client.test.ts', 'test/memory-graph-events.test.ts', 'test/trust-endpoint-validation.test.ts', 'test/daemon/plugin-loader.test.ts', 'test/daemon/routes/plugins.test.ts', 'test/auth.test.ts', 'test/supervisor-liveness.test.ts'],
